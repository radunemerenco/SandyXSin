...
module.exports = function (grunt) {
  ...
  var appConfig = {
    ...
    dist: 'dist',
    build: 'build',
    appName: require('./bower.json').name || 'myApp'
  };
  ...
  grunt.initConfig({
    ...
    compress: {
      main: {
        options: {
          archive: '<%= yeoman.build %>/<%= yeoman.appName %>.zip'
        },
        files: [
  ...
  grunt.registerTask('addHtaccess', 'Add .htaccess file to redirect to index.html', function (target) {
    grunt.file.write(
      grunt.config.data.yeoman.dist + '/.htaccess', 
