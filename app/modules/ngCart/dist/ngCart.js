...
angular.module('ngCart.directives', ['ngCart.fulfilment'])
        ...
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'partials/ngcart_addtocart.html';
                } else {
    ...
    .directive('ngcartAddtocartText', ['ngCart', function(ngCart){
        return {
            restrict : 'E',
            controller : 'CartController',
            scope: {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'partials/ngcart_addtocarttext.html';
                } else {
                    return attrs.templateUrl;
                }
            },
    ...
    .directive('ngcartCart', [function(){
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'partials/ngcart_cart.html';
                } else {
                    return attrs.templateUrl;
                }
            },
    ...
    .directive('ngcartSummary', [function(){
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'partials/ngcart_summary.html';
                } else {
                    return attrs.templateUrl;
                }
            }
    ...
    .directive('ngcartCheckout', [function(){
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'partials/ngcart_checkout.html';
                } else {
                    return attrs.templateUrl;
                }
            }
